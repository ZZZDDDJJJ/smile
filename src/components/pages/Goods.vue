<template>
  <div>
    ...
    <div class="goods-price">价格:￥{{goodsInfo.ORI_PRICE | moneyFilter}}</div>
    <div>
      <van-tabs swipeable sticky>
        <van-tab title="商品详情">
          <div class="detail" v-html="goodsInfo.DETAIL"></div>
        </van-tab>
        <van-tab title="评价">制作中</van-tab>
      </van-tabs>
    </div>
...
export default {
  ...
  methods: {
    ...
    console.log(cartInfo)
      let isHave = cartInfo.find( (cartInfo) =>{
      
       return cartInfo.goodsId == this.goodsId;
      });
      console.log(isHave)
