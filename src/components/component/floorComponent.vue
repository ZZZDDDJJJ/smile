<template>
  <div class="floor">
    ...
    <div class="floor-anomaly">
      <div class="floor-one" @click="goPages(floorData0.goodsId)">
       <img :src="floorData0.image" width="100%" />
      </div>
      <div>
        <div class="floor-two" @click="goPages(floorData1.goodsId)">
          <img :src="floorData1.image" width="100%" />
        </div>
        <div  @click="goPages(floorData2.goodsId)">
    ...
    <div class="floor-rule">
      <div v-for="(item,index) in floorData.slice(3)" :key="index"  @click="goPages(item.goodsId)">
